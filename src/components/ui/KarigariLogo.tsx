...
export function KarigariLogo({ size = 32, showWordmark = false, variant = 'dark', className = '' }: KarigariLogoProps) {
  const color = variant === 'dark' ? '#24332C' : '#FCF8F7';
  ...
  return (
    <div className={`flex items-center gap-2 ${className}`}>
      ...
      >
        ...
        <line x1="35" y1="35" x2="55" y2="30" stroke={variant === 'dark' ? '#FCF8F7' : '#1A1A1A'} strokeWidth="1.5" />
        <line x1="35" y1="45" x2="55" y2="40" stroke={variant === 'dark' ? '#FCF8F7' : '#1A1A1A'} strokeWidth="1.5" />
        <line x1="35" y1="55" x2="55" y2="50" stroke={variant === 'dark' ? '#FCF8F7' : '#1A1A1A'} strokeWidth="1.5" />
        <line x1="35" y1="65" x2="55" y2="60" stroke={variant === 'dark' ? '#FCF8F7' : '#1A1A1A'} strokeWidth="1.5" />
        ...
        <circle cx="24" cy="24" r="1.5" fill={variant === 'dark' ? '#FCF8F7' : '#1A1A1A'} />
